...
│   ├── trajectory_suggestion               # done # name # simtime
│   └── trajectory_supervision              # done # name # simtime
└── understanding
    ├── dynamic_map_enrichment              # done # name # simtime
    ├── environment_model                   # done
